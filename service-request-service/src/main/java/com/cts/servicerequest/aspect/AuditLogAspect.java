package com.cts.servicerequest.aspect;
...
import com.cts.servicerequest.aspect.audit.Auditable;
import com.cts.servicerequest.client.AuditLogClient;
...
public class AuditLogAspect {
    ...
    public void logActivity(JoinPoint joinPoint, Auditable auditable, Object result) {
        try {
            ...
            payload.put("serviceName",  "Service Request");
            payload.put("details",
